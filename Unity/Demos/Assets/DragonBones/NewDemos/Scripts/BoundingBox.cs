...
public class BoundingBox : BaseDemo
{
    ...
    protected override void OnStart()
    {
        ...
        UnityFactory.factory.LoadDragonBonesData("bounding_box/bounding_box_test_ske");
        UnityFactory.factory.LoadTextureAtlasData("bounding_box/bounding_box_test_tex");
        // Build Armature
