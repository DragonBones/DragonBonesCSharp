...
namespace dragonBones
{
    ...
    public class Animation : BaseObject
    {
         ...
         * @private
         */
        public bool _animationStateDirty;

        /**
         * @private
         */
        public bool _timelineStateDirty;
         ...
         * @private
         */
        public void _advanceTime(float passedTime)
        {
            if (!_isPlaying)
            {
                return;
        ...
        public AnimationState play(string animationName = null, int playTimes = -1)
        {
            ...
            {
                var defaultAnimation = _armature.armatureData.getDefaultAnimation();
        ...
        )
        {
            ...
            if (fadeInTime != fadeInTime || fadeInTime < 0.0f)
            {
            ...
            set
            {
                ...
                if (value != null)
                {
                    foreach (var pair in value)
                    {
                        ...
                        this._animationNames.Add(pair.Key);
                    }
                }
            }
        }
